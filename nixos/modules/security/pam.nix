...
let
  ...
  sudoConfigForSSHAgentAuth = optionalString config.security.pam.enableSSHAgentAuth ''
...

{
  ...
  config = {
    ...
    security.sudo.extraConfig = sudoConfigForSSHAgentAuth;
    security.sudo-rs.extraConfig = sudoConfigForSSHAgentAuth;
  };
}
